...
//
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
     ...
     // catch (NumberFormatException e) { max(new Byte("0")); return readByte(s+errP); }
      catch (NumberFormatException e) { max("0"); return readByte(s+errP); }
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
    ...
    //      catch (NumberFormatException e) { max(new Short("0")); return readShort(s+errP); }
      catch (NumberFormatException e) { max("0"); return readShort(s+errP); }
   }
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      ...
      catch (NumberFormatException e) { max("0"); return readInt(s+errP); }
   }
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      ...
      catch (NumberFormatException e) { max("0"); return readLong(s+errP); }
   }
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      ...
      catch (NumberFormatException e) { max("0"); return readFloat(s+errP); }
   }
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      ...
      catch (NumberFormatException e) { max("0"); return readDouble(s+errP); }
   }
...
*/
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
      ...
      try {
         ...
         out.write(text);  out.close();  // schreibe und schließe Datei
  ...
  //   private static AudioClip clip= null;
   ...
   {//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
    //   if (clip!=null) { clip.play(); wait(dauer); clip.stop(); }  
     return "";
   }
   /** WAV- und MIDI-Dateien starten */
   public static String soundStart() {// if (clip!=null) {clip.play();}
    return ""; }
   /** WAV- und MIDI-Dateien stoppen */
   public static String soundStop()  { //if (clip!=null) {clip.stop();}
    return ""; }
   /** WAV- und MIDI-Dateien starten mit Endlosschleife */
   public static String soundLoop()  { //if (clip!=null) {clip.loop();}
    return ""; }
      ...
      if (fileExists(datei)) {
         ...
         */
         try {
            ...
            catch (InterruptedException e) { //clip= null; 
            System.out.println(e.toString()); }
         }catch (MalformedURLException e) { //clip= null; 
         System.out.println(e.toString()); }
      }else  {
